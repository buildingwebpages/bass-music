...
if Album.count == 0
    ...
    a8 = Album.create(cover: "http://upload.wikimedia.org/wikipedia/en/c/c0/Rodriguezcoldfact.jpg", title: "Cold Fact", artist: "Sixto Rodriguez")
    Track.create(name: "Sugar Man", minutes: 4, album_id: a8.id)
    Track.create(name: "Only Good for Conversation", minutes: 2, album_id: a8.id)
    Track.create(name: "Crucify Your Mind", minutes: 3, album_id: a8.id)
    Track.create(name: "This Is Not a Song, It's an Outburst", minutes: 2, album_id: a8.id)
    Track.create(name: "Hate Street Dialogue", minutes: 3, album_id: a8.id)
    Track.create(name: "Forget It", minutes: 2, album_id: a8.id)
    Track.create(name: "Inner City Blues", minutes: 3, album_id: a8.id)
    Track.create(name: "I Wonder", minutes: 3, album_id: a8.id)
    Track.create(name: "Like Janis", minutes: 3, album_id: a8.id)
    Track.create(name: "Gommorah (A Nursery Rhyme)", minutes: 2, album_id: a8.id)
    Track.create(name: "Rich Folks Hoax", minutes: 3, album_id: a8.id)
    Track.create(name: "Jane S. Piddy", minutes: 3, album_id: a8.id)
